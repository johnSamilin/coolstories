...
const IndexPage = () => (
  <Layout className="index-page" lang="en">
    <SEO title="Stuff about webgl-games" />
    <header>WebGL experiments almanac</header>
    <nav>
      <ul>
        <li>
          <Link to="/en/forest">Procedural forest generation</Link>
        </li>
        <li>
          <Link to="/en/pathfinding">Pathfinding</Link>
        </li>
        <li>
          <Link to="/en/strategy">Crowd management</Link>
        </li>
      </ul>
    </nav>
